...
class StaticTracklistManager
{
    ...
    */
    ...
    private func addEvilBackground()
    {
        ...
        tracklist.add(Track(storeID: "767232885",
                        displayName: "Antarctica - The First Pod",
                     altDisplayName: nil,
                      volumePercent: 90,
                        startOffset: 0,
                          endOffset: nil,
    ...
    private func addEvilBattle()
    {
        ...
        tracklist.add(Track(storeID: "1251495276",
        ...
        tracklist.add(Track(storeID: "767232986",
    ...
    private func addEvilTwisted()
    {
        ...
        tracklist.add(Track(storeID: "1482644449",
    ...
    private func addGoodTavern()
    {
        ...
        tracklist.add(Track(storeID: "1482644577",
    ...
    private func addAnySorrow()
    {
        ...
        tracklist.add(Track(storeID: "1251496022",
                        displayName: "Bubble",
                     altDisplayName: nil,
                      volumePercent: 68,
                        startOffset: 0,
    ...
    private func addAnyValhallaGoodBackground()
    {
        ...
        tracklist.add(Track(storeID: "1562405646",
                        displayName: "Youth",
                     altDisplayName: nil,
                      volumePercent: 99,
                        startOffset: 0,
        ...
        tracklist.add(Track(storeID: "1686387572",
    ...
    private func addAnyValhallaGoodVictory()
    {
        ...
        tracklist.add(Track(storeID: "1457766579",
    ...
    private func addAnyValhallaMagicAndMystery()
    {
        ...
        tracklist.add(Track(storeID: "767230864",
                        displayName: "The Master's Theme",
                     altDisplayName: nil,
                      volumePercent: 71,
                        startOffset: 0,
                          endOffset: nil,
        ...
        tracklist.add(Track(storeID: "767232891",
                        displayName: "Into Argolis",
                     altDisplayName: nil,
                      volumePercent: 65,
                        startOffset: 0,
                          endOffset: nil,
