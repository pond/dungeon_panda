...
class StaticTracklistManager
{
    ...
    */
    ...
    private func addEvilBattle()
    {
        ...
        tracklist.add(Track(storeID: "209687227",
                        displayName: "Battle On The Rooftop",
                     altDisplayName: nil,
                      volumePercent: 100,
                        startOffset: 0,
                          endOffset: nil,
        ...
        tracklist.add(Track(storeID: "883507151",
                        displayName: "Parting - Fear Of The Shadow",
                     altDisplayName: nil,
                      volumePercent: 100,
                        startOffset: 0,
                          endOffset: nil,
    ...
    private func addEvilFailure()
    {
        ...
        tracklist.add(Track(storeID: "1580318676",
                        displayName: "Theme From Utu",
                     altDisplayName: nil,
                      volumePercent: 100,
                        startOffset: 0,
                          endOffset: nil,
    ...
    private func addAnyMagicAndMystery()
    {
        ...
        tracklist.add(Track(storeID: "1518600561",
                        displayName: "Ivan And The Whale",
                     altDisplayName: nil,
                      volumePercent: 100,
                        startOffset: 0,
                          endOffset: nil,
        ...
        tracklist.add(Track(storeID: "1580318703",
                        displayName: "Te Wheke's Trek",
                     altDisplayName: nil,
                      volumePercent: 100,
                        startOffset: 0,
                          endOffset: nil,
        ...
        tracklist.add(Track(storeID: "1580318827",
                        displayName: "Williamson Prepares For Utu",
                     altDisplayName: nil,
                      volumePercent: 100,
                        startOffset: 0,
                          endOffset: nil,
    ...
    private func addAnySorrow()
    {
        ...
        tracklist.add(Track(storeID: "1580318689",
                        displayName: "After The Raid",
                     altDisplayName: nil,
                      volumePercent: 100,
                        startOffset: 0,
                          endOffset: nil,
